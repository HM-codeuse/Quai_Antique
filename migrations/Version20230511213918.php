 ...
 */
final class Version20230511213918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP time, DROP slot_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD time TIME NOT NULL, ADD slot_id INT NOT NULL');
