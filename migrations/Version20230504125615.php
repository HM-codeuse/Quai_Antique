 ...
 */
final class Version20230504125615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD user_id INT NOT NULL, DROP user_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD user_id_id INT DEFAULT NULL, DROP user_id');
